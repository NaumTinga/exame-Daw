...
<div class="row">
	<div class="card card-secondary" style="width: 100%;">
		...
		<div class="card-body" style="padding: 20px;">
			<?php echo Form::model($medico, ['method'=>'PATCH','action'=>['App\Http\Controllers\MedicoController@update', $medico->id],'id'=>'form', 'files'=>true]); ?>
					...
					<div class="col-md-12">
						...
						<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<?php echo Form::textarea('sintomas',null,['class'=>'form-control' . ( $errors->has('especialidade') ? ' is-invalid' : '' ),'rows'=>3]); ?>	
...
<!-- /.row -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Mystuff\Naum\Laravel\Misau-WebApp\resources\views/admin/medicos/edit.blade.php ENDPATH**/ ?>